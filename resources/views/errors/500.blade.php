...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-zinc-50 dark:bg-zinc-900 flex items-center justify-center p-4">
        <div class="max-w-md w-full text-center flex flex-col items-center justify-center">
            <i class="ti ti-alert-triangle text-zinc-300 dark:text-zinc-600 mb-4" style="font-size: 64px;"></i>
            <h1 class="text-2xl font-medium text-zinc-700 dark:text-zinc-200">Server Error</h1>
            <p class="text-sm text-zinc-400 mt-2">Something went wrong. Please try again later.</p>
