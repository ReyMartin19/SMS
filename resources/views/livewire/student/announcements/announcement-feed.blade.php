<div>
    ...
    <div class="mb-8">
        ...
        <p class="text-sm text-zinc-500 mt-1">
            Stay updated with the latest updates, event notices, and news broadcasts sent to you.
        </p>
    </div>
    ...
    <div class="space-y-4 max-w-4xl">
        @if ($announcements->isEmpty())
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-12 text-center text-zinc-400 shadow-sm">
                ...
                <p class="text-xs mt-1 text-zinc-550">There are no active system or student broadcasts at this moment.</p>
            </div>
        @else
                    ...
                    <div class="flex justify-between items-start gap-4 mb-3">
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-3 mt-1.5 text-xs text-zinc-400 dark:text-zinc-500">
                                ...
                                @else
                                    <span class="inline-flex items-center px-2 py-0.5 text-[10px] font-bold rounded-full bg-orange-50 dark:bg-orange-950/20 text-orange-600 dark:text-orange-400 border border-orange-100 dark:border-orange-950/40">
                                        Student
                                    </span>
                                @endif
                            </div>
