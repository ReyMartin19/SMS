                ...
                @forelse ($schoolYears as $year)
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition">
                        ...
                        <td class="px-5 py-3 text-right flex items-center justify-end gap-3">
                            ...
                            <button wire:click="delete({{ $year->id }})" wire:confirm="Are you sure you want to delete this? This action cannot be undone." class="text-xs text-red-400 hover:text-red-600">Delete</button>
                        </td>
                    </tr>
                @empty
                    <tr>
