    ...
    <nav class="flex mb-4 text-xs text-zinc-500 font-medium" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
            ...
            <li>
                <div class="flex items-center">
                    <i class="ti ti-chevron-right text-zinc-400 text-[10px]"></i>
                    <span class="ml-1 text-zinc-800 dark:text-zinc-200 md:ml-2">Child's Grades</span>
                </div>
            </li>
        </ol>
    </nav>
        ...
        <div class="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800/50 rounded-2xl p-6 shadow-sm mb-8 flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-red-700 dark:text-red-300 mt-1">
                    No student is currently linked to your parent account. Please contact the administrator.
                </p>
            </div>
        </div>
        ...
        <div class="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/50 rounded-2xl p-6 shadow-sm mb-8 flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-amber-700 dark:text-amber-300 mt-1">
                    No active academic school year set. Child's grades cannot be loaded.
                </p>
            </div>
        </div>
    @elseif (!$enrollment)
        <div class="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/50 rounded-2xl p-6 shadow-sm mb-8 flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-amber-700 dark:text-amber-300 mt-1">
                    Your child is not enrolled for the active school year.
                </p>
            </div>
        </div>
    @else
        ...
        <div class="mb-8">
            ...
            <p class="text-sm text-zinc-500 mt-1">
                View academic performance, term marks, and final results for school year <span class="font-semibold text-zinc-700 dark:text-zinc-350">{{ $activeSchoolYear->name }}</span>.
            </p>
        </div>
                        ...
                        @if (!is_null($overallAverage))
                            <div class="px-6 py-5 bg-zinc-50 dark:bg-zinc-800/30 border-t border-zinc-150 dark:border-zinc-800 flex items-center justify-between gap-4">
                                <div class="flex items-center gap-2 text-zinc-550 dark:text-zinc-450 text-xs">
                                    ...
                                    <span>Average of all child's calculated marks for the school year</span>
                                </div>
                                <div class="flex items-center gap-3">
                                    <span class="text-xs font-semibold text-zinc-400 dark:text-zinc-555 uppercase tracking-wider">Overall Academic Average:</span>
