        ...
        <div class="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/50 rounded-2xl p-6 shadow-sm mb-8 flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-amber-700 dark:text-amber-300 mt-1">
                    Your child has no enrollment records. Please contact the administrator.
                </p>
            </div>
        </div>
    @else
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-zinc-500 mt-1">
                Viewing grades for <span class="font-medium text-zinc-700 dark:text-zinc-200">{{ $student->first_name }} {{ $student->last_name }}</span> across all school years.
            </p>
        </div>
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <span class="px-3 py-1 rounded-full text-xs font-semibold border
                                            {{ $overallAverage >= 75
                                                ...
                                                : 'bg-red-50 text-red-700 dark:bg-red-950/20 dark:text-red-455 border-red-100 dark:border-red-900/30' }}">
